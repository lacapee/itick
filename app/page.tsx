            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in">
                <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-8 border border-primary/20 shadow-xl">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {[
                      { label: "Revenue", value: "$45.2K", change: "+12%", delay: "0.2s" },
                      { label: "Tasks", value: "234", change: "+8%", delay: "0.3s" },
                      { label: "Users", value: "1.2K", change: "+24%", delay: "0.4s" },
                      { label: "Growth", value: "18%", change: "+5%", delay: "0.5s" },
                    ].map((metric, index) => (
                      <div
                        key={index}
                        className="bg-white rounded-lg p-4 border border-primary/10 animate-fade-in-up"
                        style={{ animationDelay: metric.delay }}
                      >
                        <div className="text-xs text-muted-foreground mb-1">{metric.label}</div>
                        <div className="text-2xl font-bold text-foreground mb-1">{metric.value}</div>
                        <div className="text-xs text-primary font-semibold">{metric.change}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  {/* Mock chart */}
                  <div
                    className="bg-white rounded-lg p-4 border border-primary/10 h-32 flex items-end gap-2 animate-fade-in"
                    style={{ animationDelay: "0.6s" }}
                  >
                    {[40, 65, 45, 80, 55, 90, 70].map((height, index) => (
                      <div
                        key={index}
                        className="flex-1 bg-gradient-to-t from-primary to-primary/50 rounded-t animate-scale-in"
                        style={{
                          height: `${height}%`,
              ...
              <div className="space-y-6">
                ...
                <p
                  ...
                  style={{ animationDelay: "0.2s" }}
                >
                  Get custom dashboards that display the metrics that matter most to your business, updated in
                  real-time.
                </p>
